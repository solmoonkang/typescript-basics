...
let string2 = unknown; // 단, 다음고 같이 as boolean 으로 사용할 경우 할당이 가능하다.
// Object 
let obj = {};
let arr = [];
...
// Function
let func1; // 매개변수에 타입을 설정해줘야 한다.
func1 = function (x, y) {
    return x * y;
};
let func2; // 만약, 매개변수가 없을 경우 void 타입을 설정해주면 된다.
func2 = function () {
    console.log('hi');
};
...
// let void1: void = null;
let void2 = undefined; // 단, void 타입의 경우는 undefined 할당이 가능하다.
// void
function greeting() {
    console.log('hi');
}
